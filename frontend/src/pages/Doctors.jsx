  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        <button className={`py-1 px-3 borded rounded text-sm transition-all sm:hidden ${setFilter?'bg-primary text-white':''}`} onClick={()=>showSetFilter(prev=> !prev)}>Filters</button>
        <div className={` flex-col gap-4 text-sm text-gray-600 ${setFilter?'flex':'hidden sm:flex'}`} >
